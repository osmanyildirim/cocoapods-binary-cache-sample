...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "${PODS_ROOT}/Alamofire/_Prebuilt/Alamofire.framework"
  install_framework "${PODS_ROOT}/ContextMenu/_Prebuilt/ContextMenu.framework"
  install_framework "${PODS_ROOT}/Desk360/_Prebuilt/Desk360.framework"
  install_framework "${PODS_ROOT}/DeviceKit/_Prebuilt/DeviceKit.framework"
  install_framework "${PODS_ROOT}/GoogleUtilities/_Prebuilt/GoogleUtilities.framework"
  install_framework "${PODS_ROOT}/IBAnimatable/_Prebuilt/IBAnimatable.framework"
  install_framework "${PODS_ROOT}/KDCircularProgress/_Prebuilt/KDCircularProgress.framework"
  install_framework "${PODS_ROOT}/Moya/_Prebuilt/Moya.framework"
  install_framework "${PODS_ROOT}/NVActivityIndicatorView/_Prebuilt/NVActivityIndicatorView.framework"
  install_framework "${PODS_ROOT}/PersistenceKit/_Prebuilt/PersistenceKit.framework"
  install_framework "${PODS_ROOT}/PromisesObjC/_Prebuilt/FBLPromises.framework"
  install_framework "${PODS_ROOT}/SnapKit/_Prebuilt/SnapKit.framework"
  install_framework "${PODS_ROOT}/UICKeyChainStore/_Prebuilt/UICKeyChainStore.framework"
  install_framework "${PODS_ROOT}/lottie-ios/_Prebuilt/Lottie.framework"
  install_framework "${PODS_ROOT}/mopub-ios-sdk/_Prebuilt/MoPubSDK.framework"
  install_framework "${PODS_ROOT}/nanopb/_Prebuilt/nanopb.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/mopub-ios-sdk/Core/OMSDK_Mopub.framework"
fi
